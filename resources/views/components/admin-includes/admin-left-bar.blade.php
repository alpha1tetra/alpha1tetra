        ...
        <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
            <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
                ...
                <ul class="kt-menu__nav ">
                    <li class="kt-menu__item  {{ Request::is('user/dashboard*') ? 'kt-menu__item--active' : '' }}"
                        aria-haspopup="true"><a href="{{ route('user.dashboard') }}" class="kt-menu__link "><i
                                class="kt-menu__link-icon flaticon-home"></i><span
                                class="kt-menu__link-text">Dashboard</span></a></li>
                    {{-- <li class="kt-menu__item  {{ Request::is('admin/users*') ? 'kt-menu__item--active' : '' }}"
